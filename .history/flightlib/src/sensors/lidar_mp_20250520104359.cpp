 ...
 * @LastEditTime: 2025-05-20 10:33:59 +0800
 * @LastEditors: Lac_Creeper
 * @Description: 
 * @FilePath: /flightmare/flightlib/src/sensors/lidar_mp.cpp
 */
#include "flightlib/sensors/lidar_mp.hpp"
...
void Lidar::visualThread() {
  // For visualization
  pcl::visualization::PCLVisualizer::Ptr viewer_(
    new pcl::visualization::PCLVisualizer("Lidar Viewwe"));
  viewer_->setBackgroundColor(0, 0, 0);
  viewer_->addCoordinateSystem(1.0);
  viewer_->initCameraParameters();
  viewer_->setCameraPosition(50, 50, 50, 0, 0, 0, 0, 0, 1);
