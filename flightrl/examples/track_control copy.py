'''
Author: Lac_Creeper
Date: 2026-03-07 00:53:19 +0800
LastEditTime: 2026-03-07 00:53:19 +0800
LastEditors: Lac_Creeper
Description: 
FilePath: /src/flightmare/flightrl/examples/track_control copy.py
'''
'''
Author: Lac_Creeper
Date: 2025-06-24 14:23:27 +0800
LastEditTime: 2026-03-06 20:38:05 +0800
LastEditors: Lac_Creeper
Description: 
...
class TrackPolicy(FeedForwardPolicy):
    ...
    def mlp_extractor(self, flattened_obs, **kwargs):
        ...
        print("state_data: %.2f"%(state_data[0]))
    ...
    if args.train:
        ...
        model = PPO2(
            ...
            policy_kwargs=dict(
                ...
                net_arch=[dict(pi=[64, 64], vf=[64, 64])], act_fun=tf.nn.relu),
            env=env,
            lam=0.95,
