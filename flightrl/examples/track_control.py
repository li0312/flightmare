...
LastEditTime: 2026-04-02 14:52:08 +0800
...
def main():
    ...
    if args.train:
        ...
        log_dir = rsg_root + '/trackNew_saved'
        ...
        # model = PPO2.load(log_dir + '/2026-04-02-02-07-26/best_model.zip', env=env, tensorboard_log=saver.data_dir)
