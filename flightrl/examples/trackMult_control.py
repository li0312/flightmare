...
#
from rpg_baselines.common.policies import LaserLstmPolicy, LaserMlpPolicy, MultLstm
from rpg_baselines.ppo.ppo2 import PPO2
from rpg_baselines.envs import vec_env_wrapper as wrapper
import rpg_baselines.common.util as U
#
from flightgym import TrackMultEnv_v0
...
def main():
    ...
    if not args.train:
        ...
        rospy.init_node("trackMult_env_py", anonymous=True)
    ...
    env = wrapper.FlightEnvVec(TrackMultEnv_v0(
    ...
    if args.train:
        ...
        log_dir = rsg_root + '/trackNewMult_saved'
        saver = U.ConfigurationSaver(log_dir=log_dir)
        model = PPO2(
            tensorboard_log=saver.data_dir,
            policy=MultLstm,  # check activation function
            env=env,
            lam=0.95,
        ...
        # model = PPO2.load(log_dir + '/2026-03-16-13-29-10.zip', env=env, tensorboard_log=saver.data_dir)
