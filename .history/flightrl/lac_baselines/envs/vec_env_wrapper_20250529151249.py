...
LastEditTime: 2025-05-29 15:10:22 +0800
...
class TrackEnvVec(VecEnv):
	...
	def step(self, action):
		...
		dict_obs = {"lidar": self._observation[:1536].reshape([3, 512]),
								"detect": self._observation[1536:1539],
								"state": self._observation[1539:]}
		print(dict.type)
