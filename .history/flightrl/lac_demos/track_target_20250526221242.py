...
LastEditTime: 2025-05-26 22:06:12 +0800
...
from lac_baselines.common.custom_net import *
...
def main():
  ...
  env = wrapper.TrackEnvVec(TrackEnv_v1(yaml_str, False))
  ...
  if args.train:
    ...
    model = PPO(
      ...
      policy=CustomPolicy,  # check activation function
      policy_kwargs=dict(
